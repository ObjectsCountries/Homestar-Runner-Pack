...
public class _sbemailsongs:ModdedModule{
    ...
    //for Souvenir
    private string[]transcriptionsAbridged=new string[]{
        "Oh, who is the guy that…",
        "I'm gonna check my email all of the time…",
        "Checkin' my email, checkin' my email…",
        "I check the email once…",
        ...
        "I've carefully set aside this time…",
        "I'm totally checking my email…",
        "Email, grumble grumble…",
        "Initiate email check in 5, 4, 3, 2, 1.",
        "Email, dud-duh-doo-duh-dud-duh…",
        "Must… check… email…",
        "Everybody… check your email…",
        "Who's that giving Strong Bad a hand?…",
        "Ohh! Electronic mail!",
        "Something has compelled me…",
        "Ow-mnow, mnow, mnow…",
        "Hello, everybody! This week it's time…",
        "This episode, Strong Bad checks his email.",
        "Do, du, dadada do, du, dadada do…",
        "Oh! What's this? An email? For me?!",
        "Checkin' my email… Here at The Stick…",
        "Strong Bad Email is filmed…",
        "Check that email, check it down…",
        "I got an email. I got an awesome email.",
        "This one had better be good, man…",
        "All these… emails…",
        "I'll take Strong Bad Emails…",
        "Umm… I don't know…",
        "Riballa diballa check email.",
        "Super great, super great…",
        "Time to check the email…",
        "Ah, the old girl's working again…",
        "Oh, tap your toes and check your email…",
        "Mmmmm… fresh emails…",
        "Emaillll eeeemailll eeemmailll…",
        ...
        "Oh-you-thought-there-was-no-more-emails…",
        "Strong Bad Emails are a part…",
        "In the United States alone…",
        ...
        "There once was a man named email…",
        "Chee-wit, chee-wit, chee-wi- chee-wi-email.",
        "Toons! Games! I'm gonna check my eeeemail…",
        "Ahh… so many emails, so little good emails.",
        "Welcome to the Strong Bad Email dat-daddle-dun!…",
        "Come on guys! Get your heads in the game.",
        "Oooh! Check it out!…",
        "Email, women, email, girls!…",
        "This email is brought to you by…",
        "strongbad, underscore, email…",
        "OHHHHHHHHHHHHHHHH EMAIL!!!{Rock guitar solo…",
        "Hoo! Cha! Cheritiza!…",
        "What do you get when you email Strong Bad?…",
        "I'm intrigued by these…",
        "Ooh! A little email never hurt nobody…",
        "Ohh-ho-oh ohh EEEEEMAIL ME GIRL!…",
        "Watch me do a little bit o' email…",
        "Email! Email! Email! Email!",
        "I met her in the summertime…",
        "HOMESTAR RUNNER: Hello, class…",
        "My name is not Email Sam…",
        "Oh, I took the email to the market…",
        "Tap tap tap tap tap…",
        "Email: It's like the sugar…",
        "Which email is your favorite?…",
        "Ladies and gentlemen. I give you… a-da sbemail.",
        "Haselos, theselos, haselos, theselos!",
        "Driving down the strip…",
        "POWERED BY THE CHEAT STRONG BAD: Eeeeeeeeeemail…",
        "I'm goin' to try something a little different…",
        "It's email time again!…",
        "Email me don't email me…",
        "And coming in at number 91…",
        "Thanks for choosing Strong Bad Email…",
        "Whoa. Guess it's been a while…",
        "Email is like a prison…",
        "Come on, big money! Big money!…",
        "So innocent and email free…",
        "Oh traipsing along…",
        "Do do do do, email me some words…",
        "Check your email and check your email…",
        "ONE TWO THREE FOUR—EMAIL IS AWESOME…",
        "The views expressed in the following email show…",
        "Oh email, I'm gonna let you down easy…",
        "Man, if I had a nickel for every email I get…",
        "Everybody loves this, everybody needs this…",
        "Our next show is a family show…",
        "Oh, here comes little email…",
        "Let's check a Strong Bad Email, you and me…",
        "Oh, I'm an email gambler…",
        "I'm not gonna sing an email song this week…",
        "Let's see. Make friends with Kerrek…",
        "I got an email in my pocket…",
        "Let's get it over with!…",
        "Here comes The Strong Baaaaad…",
        "I'm checkin' email, I'm checkin' email. Hey, hey…",
        "Checkin' emails with a VISCOSITY….",
        "Ow ow ow… ow ow oww… ow ow owww… email…",
        "Tonight on Strong Bad Email…",
        "I got the email, you got the email…",
        "All right! Let's see if this…",
        "I got miles and miles of the email style…",
        "A lot of ladies and a lot of girls…",
        "Oh oh, email's in the backyard…",
        "This email is leaving the station…",
        "Email, na na, na na, na na, nanaNA…",
        "Checkin' email, now take it to the flip side!",
        "You got to email, just to stay alive!",
        "And if I email you! Girl, woman!…",
        "The email checker, come on and come on, y'all…",
        "Here comes another email that I'll answer for you!…",
        "Strong Bad Email! Makes money!…",
        "{rapping} Email theme song! 1-2-3!…",
        "Can you handle my style?…",
        "This email is making fun of you.",
        "Drape it over your aaaaaaarms…",
        "{singing in falsetto} Why do I check emails…",
        "A little bit of email…",
        "I'm still here, after all these years…",
        "Email is the sound that we make…",
        "Hey everybody, it's a musical…",
        "It's the email, baby, lunch juice!",
        "Email, ah ooh, ooh, ooh ah ooh,…",
        "Initiate sbemail-refresh daemon.",
        "Don't you wanna email…",
        "I met this email on a north-bound train…",
        "I'm livin' the Strong Bad life…",
        "I was born to check emails…",
        "How many emails can you check?…",
        "This week, I'm feeling my style!…",
        "{blows on microphone and taps it} Check one, check two…",
        "I've been walkin' on clouds…",
        "Can you see that I've got email styles…",
        "A badaly-doo, it's time for email…",
        "Email is nice, habalubabulabada!…",
        "I'll take you back to a time…",
        "When email comes to town…",
        "Good morning, Mr. Email…",
        "A-when you dribble down the court…",
        "Oooh, it's a e-email, money, money, money…",
        "Green lines, green, green lines…",
        "Sippin' on a bottle of email…",
        "Start your day, the sbemail way!…",
        "A-just scrape some email off the top…",
        "Ding-ding-dong, ding-ding-dong…",
        "{slowly} Boom, tick. Tick-a-tick-a-tick…",
        "I'm doin' a party…",
        "I am Strong Bad, and I am not…",
        "Coach Z is not that cool…",
        "Strong Bad, how you gonna check…",
        "Oh, tiptoe your fingers 'cross the keyboard…",
        "Sweetheart, get dressed and brush…",
        "My email song!…",
        "Bring to me a suitable email…",
        "Check the deck, y'all! Press eject, y'all!…",
        "Email, I'm so in love with you…",
        "I'm running through a field of emails!…",
        "Step 1! You check an email down…",
        "Gropin' around in the dark…",
        "Letters. And words…",
        "Let a lil' email into your heart…",
        "Gary. I hope this email's from Gary.",
        "Strong Bad Email goes down…",
        "When I was sixteen…",
        "Emailin' from the left to the right…",
        "I baked you this special email!…",
        "Another week, another email scandal!…",
        "I'm chicky-checkin' emails in 2008!…",
        "Ooh, emails make me tremble…",
        "Green green grass… A pleasant ghost…",
        "Continue to roast your Strong Bad Email…",
        "Save the gross stuff up…",
        "Oh, who's checkin' emails…",
        "Back again. Checking email from my friends…",
        "My email is a cell phone. No it's not!…",
        "If everybody in the world checked their email…",
        "Girl, where's my money that you owe me…",
        "Junk it, and check it…",
        "Another freakin' email…",
        "I'm gonna check my {grunt}…",
        "I had to pay the doctor…",
        "THE POOPSMITH: {singing} Two hundred sbemails…",
        "Oh, man, I haven't checked my email in so long…",
        "Checking emails at home from your work computer…",
        "To check my email, all I gotta do is click…",
        "Oh, people can you feel me? To email me?…",
        "Checkin' emails with boxing gloves…",
        "Emails are like Hot Pockets…",
        "Let's not make a big deal out of this!…",
        "If I can't check my email…",
        "And I can check my wha?…"
    };
    void Start(){
